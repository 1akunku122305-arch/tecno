...
export function CategoryManager({ categories }: { categories: Category[] }) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <form onSubmit={create} className="space-y-4 rounded-2xl border border-ink-200/80 bg-white p-5">
      ...
      <div className="rounded-2xl border border-ink-200/80 bg-white p-5 lg:col-span-2">
              ...
              <li key={c.id} className="flex items-center justify-between gap-3 py-3">
                <div className="min-w-0">
                  <p className="font-semibold text-ink-900">
                    {c.name}{" "}
                    <span className={"ml-1 text-[11px] font-medium " + (c.is_active ? "text-emerald-600" : "text-ink-400")}>
